...
dag = DAG(
    ...
    params={
        ...
        "GROUND_TRUTH_DIR": os.getenv("GROUND_TRUTH_DIR", os.path.join(TESSTRAIN_PROJECT_DIR, "data/ground_truth")),
        ...
        "LOG_FILE": os.getenv("TESSTRAIN_LOG_FILE", os.path.join(TESSTRAIN_PROJECT_DIR, "plot/output_kbd_airflow.log")),
